...
fftw_plan	r2c_2d, c2r_2d, r2c_1d, c2r_1d, r2cfft_2Dslice;
...
fftw_plan	r2cfft_mpi_t, r2cfft_mpi, c2rfft_mpi, c2rfft_mpi_t, r2cfft_2D,r2cfft_2Dslice;
...
void finish_gfft() {
	...
	fftw_destroy_plan(r2cfft_2D);
	fftw_destroy_plan(r2cfft_2Dslice);

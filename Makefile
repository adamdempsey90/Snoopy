...
CC=gcc
MPICC=mpicc
CFLAGS=-O3 -fomit-frame-pointer -malign-double -fstrict-aliasing -ffast-math -I/home/amd616/fftw-3.3.3/include
OPENMP_FLAG = 
LIBS= -lfftw3_mpi -lfftw3 -lm 
LDFLAGS= -L/home/amd616/fftw-3.3.3/lib

ifeq ($(DEBUG),yes)
	CFLAGS=-g -O2 -I/home/amd616/fftw-3.3.3/include -DDEBUG
	LDFLAGS= -L/home/amd616/fftw-3.3.3/lib
endif
